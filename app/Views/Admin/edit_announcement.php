                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4 col-span-1 md:col-span-2">
                            ...
                            <textarea id="content" name="content" rows="5"
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?= session()->getFlashdata('errors.content') ? 'border-red-500' : '' ?>"><?= old('content', $announcement['content']) ?></textarea>
