    ...
    <main class="flex-1 overflow-y-auto">
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <form action="<?= base_url('User/feedbacks/update/' . $feedback['id']) ?>" method="post">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4 hidden">
                            <label for="user_id" class="block text-gray-700 font-medium mb-2">User ID *</label>
                            <input type="text" id="user_id" name="user_id" 
                                value="<?= $feedback['user_id'] ?? old('user_id') ?>"
                                readonly
                        ...
                        <div class="mb-4 col-span-1 md:col-span-2" >
                            ...
                            <select id="feedback_type " name="feedback_type"
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 readonly focus:ring-blue-500 <?= session()->getFlashdata('errors.feedback_type') ? 'border-red-500' : '' ?>">
