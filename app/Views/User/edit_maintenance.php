    ...
    <main class="flex-1 overflow-y-auto">
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <form action="<?= base_url('User/maintenance/update/' . $maintenance['maintenance_id']) ?>" method="post">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="resident_id" name="resident_id" readonly
                                class="w-full px-4 py-2 border readonly rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?= session()->getFlashdata('errors.resident_id') ? 'border-red-500' : '' ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="room_id" name="room_id" readonly
                                class="w-full px-4 py-2 border readonly rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?= session()->getFlashdata('errors.room_id') ? 'border-red-500' : '' ?>">
                        ...
                        <div class="mb-4 col-span-1 md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="5"
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?= session()->getFlashdata('errors.description') ? 'border-red-500' : '' ?>"><?= old('description', $maintenance['description']) ?></textarea>
                        ...
                        <div class="mb-4 col-span-1">
                            ...
                            <div class="px-4 py-2 border rounded-md bg-gray-100">
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        <!-- Delete button -->
                        <a href="<?= base_url('User/maintenance/delete/' . $maintenance['maintenance_id']) ?>" 
